...
The best way to experience the project is to follow this short scenario first before free-form exploration.
...
### Scenario 3: Contingency and Fallback Checks
...
This section is included for accountability and grading clarity.
...
### 2. Analyst scope is lighter than it could be
The project includes analyst role support and stores allowed sections, but the current experience is stronger on role-aware access than on deep analyst-specific report-authoring workflows. This is an area that could be expanded further.

### 3. Dataset size affects some visualizations
...
### 4. Session-summary feature is a lightweight interpretation
...
### 5. Export quality is functional but not fully polished
...
### 6. Administrative surface is read-focused
...
### 7. Error handling is much stronger than earlier phases, but still not perfect
...
The intended experience of the project is:
- lightweight and server-rendered
- role-aware
- centered on saved reports as the main deliverable
- export-capable
- performance-conscious
- improved with more polished presentation and extra visualization work

After following the suggested scenario above, please feel free to explore the project freely.